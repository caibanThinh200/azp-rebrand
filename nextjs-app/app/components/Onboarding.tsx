  ...
  return (
    <>
      ...
      <div>
        {!isPresentation ? (
          <Link
            className="inline-flex rounded-full gap-2 items-center bg-white py-3 px-6 text-black"
            href={link.href}
            // target="_blank"
          >
            {link.title}
          ...
          <button
            className="cursor-pointer inline-flex rounded-full gap-2 items-center bg-white hover:bg-red-100 py-3 px-6 text-black"
...
export function PageOnboarding() {
  return (
    <div className="container mx-auto space-y-10 gap-6 py-12 text-center bg-light-brown text-white rounded-lg p-8">
      <OnboardingMessage
        message={{
          title: "Trang này không tồn tại",
          description: "Vui lòng quay về trang chủ",
        }}
        link={{
