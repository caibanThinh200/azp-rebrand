...
const Filter = () => {
    return <div className="flex lg:gap-10 gap-5 items-center flex-col lg:flex-row">
        <div className="flex-1 w-full"><Input icon={<Search />} placeholder="Tìm kiếm sản phẩm" /></div>
        ...
        <div className="flex-1 w-full">
            <Select>
                ...
                <SelectContent>
                    <SelectItem value="light"><span className="size-10 rounded bg-red-600"></span>
                        Đỏ
                    </SelectItem>
                    <SelectItem value="dark"><span className="size-10 rounded bg-blue-600"></span>Xanh</SelectItem>
